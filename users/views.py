...
from organization.models import CourseDep
    ...
    def post(self, request):
        ...
        if login_form.is_valid():
            ...
            if user is not None:
                ...
                return render(request, 'login.html', {'msg': '用户账号未激活', 'login_form': login_form})
        else:
...
class IndexView(View):
    ...
    def get(self, request):
        ...
        course_deps = CourseDep.objects.all()[:15]
        return render(request, 'index.html', {
            'courses': courses,
            'course_deps': course_deps,
        })
